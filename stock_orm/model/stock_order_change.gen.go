...
const TableNameStockOrderChange = "stock_order_change"
...
// TableName StockOrderChange's table name
func (*StockOrderChange) TableName() string {
	return TableNameStockOrderChange
}
