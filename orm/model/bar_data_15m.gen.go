...
const TableNameBarData15m = "bar_data_15m"
...
type BarData15m struct {
	...
	BarType           string  `gorm:"column:bar_type;type:varchar(10);not null;default:15m;comment:时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M" json:"bar_type"` // 时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M
...
// TableName BarData15m's table name
func (*BarData15m) TableName() string {
	return TableNameBarData15m
}
