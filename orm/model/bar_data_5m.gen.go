...
const TableNameBarData5m = "bar_data_5m"
...
type BarData5m struct {
	...
	BarType           string  `gorm:"column:bar_type;type:varchar(10);not null;default:5m;comment:时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M" json:"bar_type"` // 时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M
...
// TableName BarData5m's table name
func (*BarData5m) TableName() string {
	return TableNameBarData5m
}
