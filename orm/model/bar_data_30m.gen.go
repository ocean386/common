...
const TableNameBarData30m = "bar_data_30m"
...
type BarData30m struct {
	...
	BarType           string  `gorm:"column:bar_type;type:varchar(10);not null;default:30m;comment:时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M" json:"bar_type"` // 时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M
...
// TableName BarData30m's table name
func (*BarData30m) TableName() string {
	return TableNameBarData30m
}
