...
const TableNameBarData1h = "bar_data_1h"
...
type BarData1h struct {
	...
	BarType           string  `gorm:"column:bar_type;type:varchar(10);not null;default:1H;comment:时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M" json:"bar_type"` // 时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M
...
// TableName BarData1h's table name
func (*BarData1h) TableName() string {
	return TableNameBarData1h
}
