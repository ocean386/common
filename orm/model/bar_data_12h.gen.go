...
const TableNameBarData12h = "bar_data_12h"
...
type BarData12h struct {
	...
	BarType           string  `gorm:"column:bar_type;type:varchar(10);not null;default:12H;comment:时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M" json:"bar_type"` // 时间粒度类型:默认值1m,1m/5m/15m/30m/1H/4H/12H/1D/1W/1M
...
// TableName BarData12h's table name
func (*BarData12h) TableName() string {
	return TableNameBarData12h
}
